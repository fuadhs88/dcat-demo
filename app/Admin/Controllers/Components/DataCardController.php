...
class DataCardController extends Controller
{
    ...
    protected function default()
    {
        $cards[] = DataCard\Card::make()
            ->title('Daily active user growth')
        ...
        $cards[] = DataCard\Card::make()
            ...
            ->content(function () { // 这里设置Default值，设置0即可
        ...
        return $this->box('Default卡片', $cards);
    }
    ...
    {
        switch ($condition) { // Different data can be queried according to the parameters passed by the interface
            case 'Last 30 days':
                // TODO
                break;
            case 'Last 3 months':
                // TODO
                break;
            case 'Nowadays': // When entering the page for the first time (not clicking the button to request the interface), the interface does not include this parameter value.
            default:    // So here today is put together with default
                // TODO
                break;
        }
    ...
    protected function chartJs()
    {
        $cards[] = DataCard\DoughnutChartCard::make()
            ...
            }, 'BLUE'); // 再设置一个下拉菜单，并设置按钮Default显示值
