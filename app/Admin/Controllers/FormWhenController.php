...
class FormWhenController
{
    ...
    {
        return $content->title('Dynamic form display')
...
HTML
    ...
    protected function form()
    {
        ...
        $form->tab('Radio', function (Form $form) {
            $form->display('title')->value('Dynamic display of radio buttons');
        ...
        $form->tab('Checkbox', function (Form $form) {
            $form->display('title')->value('Checkbox dynamic display');
        ...
        $form->tab('MultipleSelect', function (Form $form) {
            $form->display('title')->value('Dynamic display of multiple selections from drop-down box');
