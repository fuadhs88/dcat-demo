...
| :---------------------------------------------- |:--------------------------------- | :------------------------------------------------- |
| F9                                              | 切换实时Preview                       | Switch watch/unwatch                               |
| F10                                             | 全屏HTMLPreview (按 Shift + ESC 退出) | Full preview HTML (Press Shift + ESC exit)         |
...
| Ctrl + K / Command + K                          | 插入行内Code                      | Insert inline code                                 |
| Ctrl + L / Command + L                          | 插入链接                          | Insert link                                        |
| Ctrl + U / Command + U                          | 插入无序tables                       | Insert unordered list                              |
| Ctrl + Q                                        | Code折叠切换                      | Switch code fold                                   |
| Ctrl + Z / Command + Z                          | 撤销                              | Undo                                               |
| Ctrl + Y / Command + Y                          | 重做                              | Redo                                               |
| Ctrl + Shift + A                                | 插入@链接                         | Insert &#64;link                                   |
| Ctrl + Shift + C                                | 插入行内Code                      | Insert inline code                                 |
...
| Ctrl + Shift + O                                | 插入有序tables                       | Insert ordered list                                |
...
| Ctrl + Shift + T                                | 打开插入Form对话框                | Open table dialog                                  |
| Ctrl + Shift + U                                | 将所选文字转成大写                | Selection text convert to uppercase                |
| Shift + Alt + C                                 | 插入```Code                       | Insert code blocks (```)                           |
...
| Ctrl + Shift + Alt + C                          | 打开插入Code块对话框层            | Open code blocks dialog                            |
